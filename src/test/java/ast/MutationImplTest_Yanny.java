...
class MutationImplTest_Yanny {
    @Test
    void test_mutation1_1() throws SyntaxError {
    ...
    void test_mutation1_2() throws SyntaxError, NoMaybeValue {
        ...
        // p.nodeAt(5) is a BinaryExpr, expressing "SIZE * 400".
        Node n = m.apply(p,p.nodeAt(5)).get();
        System.out.println(n);

    }

    @Test
    void test_mutation3_1() throws SyntaxError, NoMaybeValue{
    ...
    void test_mutation3_2() throws SyntaxError, NoMaybeValue{
        ...
        // p.nodeAt(6) is a Command, expressing "bud".
        // p.nodeAt(7) is an Action, expressing "bud".

        assert(!m.canApply(p.nodeAt(6)));
        assert(!m.canApply(p.nodeAt(7)));
        //System.out.println(m.apply(p,p.nodeAt(2)).get());
    ...
    void test_mutation4_1() throws SyntaxError, NoMaybeValue{
        ...
        // p.nodeAt(24) is an Action, representing "backward"
        Node n = m.apply(p,p.nodeAt(24)).get(); // mutating "backward"
        System.out.println(n);
    }
